...
public class R02_Servlet extends HttpServlet {
	...
	protected void funcServ(HttpServletRequest req, HttpServletResponse resp ,String strReq ) throws ServletException, IOException {
		...
		String strPath = "/jsp/R02_search_disp.jsp";
...
*/
				...
				ArrayList<HashMap<String, String>> ary = null;
				...
				try {
					...
					while(rs.next()) {
						...
						String strDname = rs.getString("f_name");

						map.put("f_id",rs.getString("f_id"));
						map.put("f_name",strDname);
